...
const Card = ({ property }) => {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-md border border-gray-100 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transform transition-all duration-300 hover:scale-105 relative group">
      ...
      <button className="absolute bottom-5 right-5 bg-gradient-to-tr from-pink-500 to-fuchsia-500 text-white p-3 rounded-full shadow-xl opacity-0 group-hover:opacity-100 scale-90 group-hover:scale-100 transition-all duration-300 flex items-center justify-center"
